...
@WebServlet("/search/moviesearch.do")
public class MovieSearchController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pagingStr = MoviePaging.pagingstr(totalCount, pageSize, blockPage, pageNum, "./moviesearch.do", sort);
		...
		req.getRequestDispatcher("/search/moviesearch.jsp").forward(req, resp);
	}
