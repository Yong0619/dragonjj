...
@WebServlet("/contents/musicList.do")
public class MusicListController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pagingStr = MusicPaging.pagingstr(totalCount, pageSize, 
				blockPage, pageNum, "./musicList.do", sort);
		...
		req.getRequestDispatcher("/contents/hdmusiclist.jsp").forward(req, resp);
