...
<body>
	<header class="inner">
        <div id="head1">
            <div id="logo1"><a href="/project01/index.do"><img src="/project01/images/logo2 nobc.png" alt=""></a></div>
            <form>
            <ul id="login">
            <% 
            	if(session.getAttribute("UserName") != null) {
			 %>
                <li><a href="/project01/logout.do">로그아웃</a></li>
            ...
            %>
            			...
            			<li><a href="/project01/contents/upload.jsp">컨텐츠관리</a></li>
            <%
					}
            	} else {
            %>
        ...
        <div id="head2">
            <ul id="hmenu">
                <li><a href="/project01/contents/movieList.do">영화</a></li>
                <li><a href="/project01/contents/dramaList.do">드라마</a></li>
                <li><a href="/project01/contents/musicList.do">음악</a></li>
            </ul>
			<!--  검색 -->
			<form method="get">
